<link rel="favicon" href="<?php echo base_url().'/uploads/system/favicon.png' ?>">
<link rel="apple-touch-icon" href="<?php echo base_url().'/uploads/system/favicon.png'; ?>">
...
<link rel="stylesheet" href="<?php echo base_url().'assets/frontend/custom_main.css'; ?>">