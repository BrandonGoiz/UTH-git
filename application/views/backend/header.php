    ...
    <div class="container-fluid">
        ...
        <a href="<?php echo site_url($this->session->userdata('role')); ?>" class="topnav-logo" style = "min-width: unset;">
            ...
            <span class="topnav-logo-lg">
                <img src="<?php echo base_url() . 'assets/frontend/images/StateraLogoBlancoHorizontal.png'; ?>" alt="">
            </span>
...
<div class="visit_website">
    <h4 style="color: #fff; float: left;display:none;"> <?php echo $this->db->get_where('settings' , array('key'=>'system_name'))->row()->value; ?></h4>
