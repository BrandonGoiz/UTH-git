    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('Formulario de edición de alumno o coach'); ?></h4>
                
                <a href="<?php echo site_url('admin/enrol_history/filter_by_date_range?date_range=January+1%2C+2020+-+January+31%2C+2099&id_alumno='.$user_id); ?>" class="btn btn-info">Eliminar cursos</a>
                                
                
                <form style="margin-top:15px;" class="required-form" action="<?php echo site_url('admin/users/edit/'.$user_id); ?>" enctype="multipart/form-data" method="post">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="edad" name="edad" value="<?php echo $user_data['edad']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="ciudad_nacimiento" name="ciudad_nacimiento" value="<?php echo $user_data['ciudad_nacimiento']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="ciudad_residencia"><?php echo get_phrase('Ciudad de residencia:'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="ciudad_residencia" name="ciudad_residencia" value="<?php echo $user_data['ciudad_residencia']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="nivel_educativo"><?php echo get_phrase('Nivel educativo:'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="nivel_educativo" name="nivel_educativo" value="<?php echo $user_data['nivel_educativo']; ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="sexo"><?php echo get_phrase('Sexo:'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="sexo" name="sexo" value="<?php echo $user_data['sexo']; ?>">
                                            </div>
                                        </div>
