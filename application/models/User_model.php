...
class User_model extends CI_Model {
    ...
    public function add_user() {
        ...
        if ($validity == false) {
            ...
            $data['tipo_usuario'] = html_escape($this->input->post('tipo_usuario'));
            $data['empresa'] = html_escape($this->input->post('empresa'));
            $data['edad'] = html_escape($this->input->post('edad'));
            $data['estatura'] = html_escape($this->input->post('estatura'));
            $data['puesto'] = html_escape($this->input->post('puesto'));
            $data['area'] = html_escape($this->input->post('area'));
            $data['ciudad_nacimiento'] = html_escape($this->input->post('ciudad_nacimiento'));
            $data['ciudad_residencia'] = html_escape($this->input->post('ciudad_residencia'));
            $data['nivel_educativo'] = html_escape($this->input->post('nivel_educativo'));
            $data['sexo'] = html_escape($this->input->post('sexo'));
            $data['peso'] = html_escape($this->input->post('peso'));
            $data['frecuencia_cardiaca'] = html_escape($this->input->post('frecuencia_cardiaca'));
            $data['frecuencia_ejercicio'] = html_escape($this->input->post('frecuencia_ejercicio'));
            $data['duracion_ejercicio'] = html_escape($this->input->post('duracion_ejercicio'));
            $data['intensidad_ejercicio'] = html_escape($this->input->post('intensidad_ejercicio'));
            $data['circunferencia_cintura'] = html_escape($this->input->post('circunferencia_cintura'));
            $data['pulso_reposo'] = html_escape($this->input->post('pulso_reposo'));
            $data['lectura_v02max'] = html_escape($this->input->post('lectura_v02max'));
            $data['score_v02max'] = html_escape($this->input->post('score_v02max'));
            $data['lectura_p_arterial'] = html_escape($this->input->post('lectura_p_arterial'));
            $data['score_p_arterial'] = html_escape($this->input->post('score_p_arterial'));
            $data['lectura_p_reposo'] = html_escape($this->input->post('lectura_p_reposo'));
            $data['score_p_reposo'] = html_escape($this->input->post('score_p_reposo'));
            $data['lectura_cardio'] = html_escape($this->input->post('lectura_cardio'));
            $data['score_cardio'] = html_escape($this->input->post('score_cardio'));
            $data['lectura_bolt'] = html_escape($this->input->post('lectura_bolt'));
            $data['score_bolt'] = html_escape($this->input->post('score_bolt'));
            $data['lectura_pct_musculo'] = html_escape($this->input->post('lectura_pct_musculo'));
            $data['score_pct_musculo'] = html_escape($this->input->post('score_pct_musculo'));
            $data['lectura_pct_grasa'] = html_escape($this->input->post('lectura_pct_grasa'));
            $data['score_pct_grasa'] = html_escape($this->input->post('score_pct_grasa'));
            $data['lectura_c_corporal'] = html_escape($this->input->post('lectura_c_corporal'));
            $data['score_c_corporal'] = html_escape($this->input->post('score_c_corporal'));
            $data['lectura_sit_rais'] = html_escape($this->input->post('lectura_sit_rais'));
            $data['score_sit_rais'] = html_escape($this->input->post('score_sit_rais'));
            $data['lectura_fuerza_agarre'] = html_escape($this->input->post('lectura_fuerza_agarre'));
            $data['score_fuerza_agarre'] = html_escape($this->input->post('score_fuerza_agarre'));
            $data['lectura_fuerza'] = html_escape($this->input->post('lectura_fuerza'));
            $data['score_fuerza'] = html_escape($this->input->post('score_fuerza'));
            $data['total'] = html_escape($this->input->post('total'));
            $data['health_score'] = html_escape($this->input->post('health_score'));
