...
class Admin extends CI_Controller {
  ...
  public function users($param1 = "", $param2 = "") {
    ...
    $page_data['page_title'] = get_phrase('Alumnos / Coaches');
  ...
  public function user_form($param1 = "", $param2 = "") {
    ...
    if ($param1 == 'add_user_form') {
      ...
      $page_data['page_title'] = get_phrase('Agregar alumno o coach');
      $this->load->view('backend/index', $page_data);
    }
    elseif ($param1 == 'edit_user_form') {
      $page_data['page_name'] = 'user_edit';
      $page_data['user_id'] = $param2;
      $page_data['page_title'] = get_phrase('Editar alumno o coach');
      $this->load->view('backend/index', $page_data);
    }
  }
  ...
  public function enrol_history($param1 = "") {
    ...
    $idAlumno                   = $this->input->get('id_alumno');
    if ($param1 != "") {
    ...
    $page_data['enrol_history'] = $this->crud_model->enrol_history_by_date_range($page_data['timestamp_start'], $page_data['timestamp_end'],$idAlumno);
